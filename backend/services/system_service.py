...
def formatar_tamanho_arquivo(tamanho_arquivo_bytes: float) -> str:
    """Formata tamanho em bytes para formato legível."""
    if tamanho_arquivo_bytes < 1024:
        return f"{tamanho_arquivo_bytes} B"
    if tamanho_arquivo_bytes < 1024**2:
        return f"{tamanho_arquivo_bytes / 1024:.1f} KB"
    if tamanho_arquivo_bytes < 1024**3:
        return f"{tamanho_arquivo_bytes / 1024**2:.1f} MB"
    return f"{tamanho_arquivo_bytes / 1024**3:.1f} GB"
