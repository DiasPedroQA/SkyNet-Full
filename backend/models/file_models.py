# pylint: disable=E0401, line-too-long
...
from backend.app.infrastructure.models.comum_base import CaminhoBase
...
class ArquivoInfo(CaminhoBase):
    ...
    def validar_arquivo(cls, caminho_valor: str) -> str:
        ...
        """
        caminho_validado: Path = super().validar_caminho(caminho_valor)
    ...
    def info_completa(self) -> dict[str, object]:
        ...
        """
        info_base: dict[str, str | bool | int | datetime | list[dict[str, str | int | bool | None]] | None] = (
            self.info_detalhada.copy()
        )
